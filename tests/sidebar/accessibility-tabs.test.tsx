 ...
 * - MultiTabContentPreview: Expand/collapse states, tab management accessibility
...
import { MultiTabContentPreview } from '@sidebar/components/MultiTabContentPreview';
...
describe('Tab Components Accessibility', () => {
  ...
  describe('MultiTabContentPreview Accessibility', () => {
    ...
    it('should have no axe violations', async () => {
      const { container } = render(<MultiTabContentPreview {...defaultPreviewProps} />);
      const results = await axe(container, {
        rules: {
    ...
    it('should use proper ARIA expanded states for collapsible tabs', async () => {
      const user = userEvent.setup();
      render(<MultiTabContentPreview {...defaultPreviewProps} />);
