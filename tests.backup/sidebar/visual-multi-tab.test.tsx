/**
 * @file Visual Regression Tests for ContentPreview Component
 *
 * Visual snapshot tests for the ContentPreview component covering:
 ...
 */
const renderAndSnapshot = (props: Partial<ContentPreviewProps> = {}, description = '') => {
  const { container } = render(<ContentPreview {...defaultProps} {...props} />);
  expect(container.firstChild).toMatchSnapshot(description);
  return container;
};

describe('ContentPreview Visual Regression Tests', () => {
