/**
 * @file ContentPreview Component Tests
 *
 * Comprehensive tests for the ContentPreview component covering:
...
import { ContentPreview, ContentPreviewProps } from '@sidebar/components/ContentPreview';
import type { TabContent } from '@/types/tabs';
import type { ExtractedContent } from '@/types/extraction';

// Mock the TabContentItem component for cleaner testing
vi.mock('@sidebar/components/TabContentItem', () => ({
  TabContentItem: vi.fn(({ content, loading, error, onReextract, onClearContent, className }) => (
 ...
 */
const defaultProps: ContentPreviewProps = {
 ...
 */
const renderContentPreview = (props: Partial<ContentPreviewProps> = {}) => {
  return render(<ContentPreview {...defaultProps} {...props} />);
};

describe('ContentPreview', () => {
  describe('Basic Rendering', () => {
    it('should render nothing when no content is provided', () => {
      const { container } = renderContentPreview({
    ...
    it('should apply custom className', () => {
      const { container } = renderContentPreview({ className: 'custom-preview' });
    ...
    it('should not show clear all button with only current tab', () => {
      renderContentPreview({ additionalTabsContent: [] });
    ...
    it('should display correct tab count in clear all button', () => {
      ...
      renderContentPreview({ additionalTabsContent: additionalTabs });
  ...
  describe('Warning Banner', () => {
    it('should show warning when more than 10 tabs are loaded', () => {
      ...
      renderContentPreview({ additionalTabsContent: manyTabs });
    ...
    it('should not show warning with 10 or fewer tabs', () => {
      ...
      renderContentPreview({ additionalTabsContent: tenTabs });
    ...
    it('should show warning with exactly 11 tabs', () => {
      ...
      renderContentPreview({ additionalTabsContent: elevenTabs });
  ...
  describe('Expand/Collapse Functionality', () => {
    ...
    it('should preserve expand state when re-rendering', async () => {
      const user = userEvent.setup();
      const { rerender } = renderContentPreview();

      const toggleButton = screen.getByLabelText('Expand Test Tab 2');
      await user.click(toggleButton);

      // Re-render with same props
      rerender(<ContentPreview {...defaultProps} />);
  ...
  describe('Tab Management Actions', () => {
    it('should call onRemoveTab when remove button is clicked', async () => {
      ...
      renderContentPreview({ onRemoveTab: mockOnRemoveTab });
    ...
    it('should call onClearAllTabs when clear all button is clicked', async () => {
      ...
      renderContentPreview({ onClearAllTabs: mockOnClearAllTabs });
    ...
    it('should call onReextractTab from ContentPreview', async () => {
      ...
      renderContentPreview({ onReextractTab: mockOnReextractTab });
    ...
    it('should call onClearTabContent from ContentPreview', async () => {
      ...
      renderContentPreview({ onClearTabContent: mockOnClearTabContent });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle component unmounting during async operations', () => {
      const { unmount } = renderContentPreview();
